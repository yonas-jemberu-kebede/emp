...
class GradePolicy
{
    ...
    {
       return $user->hasRole('admin') || $user->hasPermissionTo('view_any_grade');
    }
    ...
    public function view(User $user, Grade $grade): bool
    {
        return $user->hasRole('admin') ||
            $user->hasPermissionTo('view_grade') && (
                $user->hasRole('teacher') || $grade->student_id === $user->id
            );
    }
    ...
    {
        return $user->hasRole('admin') || $user->hasPermissionTo('create_grade');
    }
    ...
    {
        return $user->hasRole('admin') || $user->hasPermissionTo('update_grade');
    }
    ...
    {
        return $user->hasRole('admin') || $user->hasPermissionTo('delete_grade');
    }
